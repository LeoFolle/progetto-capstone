...
module.exports = "<h2 class=\"text-center\">Ordine</h2>\n<ul>\n    <li *ngFor=\"let order of orders.productOrders\">\n        {{ order.product.name }} - €{{ order.product.price }} x {{ order.quantity}} pezzi.\n    </li>\n</ul>\n<h3 class=\"text-right\">Totale: €{{ total }}</h3>\n\n<button class=\"btn btn-primary btn-block\" (click)=\"pay()\" *ngIf=\"!paid\">Paga</button>\n\n<div class=\"alert alert-success\" role=\"alert\" *ngIf=\"paid\">\n    <strong>Congratulazioni!</strong> Il tuo ordine è stato eseguito con successo.\n</div>\n"
...
module.exports = "<div class=\"card text-white bg-danger mb-3\" style=\"max-width: 18rem;\">\n    <div class=\"card-header text-center\">Carrello</div>\n    <div class=\"card-body\">\n        <h5 class=\"card-title\">Totale: €{{total}}</h5>\n        <hr>\n\n\n        <ul>\n            <li *ngFor=\"let order of orders.productOrders\">\n                {{ order.product.name }} - {{ order.quantity}} pezzi.\n            </li>\n        </ul>\n\n        <button class=\"btn btn-light btn-block\" (click)=\"finishOrder()\"\n                [disabled]=\"orders.productOrders.length == 0\">Pagamento\n        </button>\n    </div>\n</div>\n"
...
module.exports = __webpack_require__(/*! /Users/leo/Desktop/beta/src/main/js/ecommerce/src/main.ts */"./src/main.ts");
